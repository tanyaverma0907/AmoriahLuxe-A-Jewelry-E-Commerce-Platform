...
const ProductCard = ({ product, index, wishlist, toggleWishlist, addToCart, animId }) => {
  ...
  const img = product.image || product.imageUrl || product.img ||
...
export default function ShopPage() {
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        setError(e.message);
        setProducts([
          { _id:"p1", name:"Halo Diamond Ring", type:"Rings",     material:"14k Gold",       price:2999, rating:5, badge:"New",  image:"https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=600" },
          ...
          { _id:"p3", name:"Infinity Gold Necklace", type:"Necklaces",material:"14k Gold",   price:3499, rating:5, badge:null,   image:"https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=600" },
          { _id:"p4", name:"Diamond Tennis Bracelet",type:"Bracelets",material:"14k Gold",   price:4299, rating:5, badge:"Sale", image:"https://images.unsplash.com/photo-1573408301185-9519f94816b5?w=600", originalPrice:5499 },
          { _id:"p5", name:"Twisted Gold Hoops",    type:"Earrings", material:"14k Gold",    price:1799, rating:4, badge:null,   image:"https://images.unsplash.com/photo-1629224316810-9d8805b95e76?w=600" },
          ...
          { _id:"p10",name:"Vintage Band Ring",      type:"Rings",    material:"14k Gold",   price:3199, rating:5, badge:"Limited",image:"https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=700" },
          { _id:"p11",name:"Layered Coin Necklace",  type:"Necklaces",material:"14k Gold",   price:2299, rating:4, badge:null,   image:"https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?w=700" },
          { _id:"p12",name:"Gold Cuff Bracelet",     type:"Bracelets",material:"14k Gold",   price:2799, rating:4, badge:"Sale", image:"https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=700", originalPrice:3299 },
        ]);
      } finally {
        setLoading(false);
      }
  ...
  const MAT_COLORS= { "14k Gold":"#d4a017", "Vermeil":"#c9a86c", "Sterling Silver":"#a8a9ad", "Rose Gold":"#b76e79" };
        ...
        <div className="hero-pattern" style={{
          ...
          <div style={{
            ...
            <div style={{maxWidth:1200, margin:"0 auto", padding:"0 28px",
              ...
              {["All", ...(types.length ? types : ["Rings","Necklaces","Earrings","Bracelets"])].map((t,i) => {
